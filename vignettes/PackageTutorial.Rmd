...
#Installing the R Package Lander_pkg
...
download.file(url = "https://raw.githubusercontent.com/annalander/lander_pck/master/Data/AGP%2Bfield%2Bdata%2Bcopy.csv", destfile = "/cloud/project/AGP+field+data+copy.csv")
```
...
This function is designed specifically to clear NA values from the given data set for better interpretation of data. 
...
This function pulls specific columns from the amphibian data set (such as critter, svl, mass, and stage) and creates a data frame that can be utilized for other functions.
